...
impl HighlightRenderer {
    ...
    fn update_box_instances(&mut self, device: &wgpu::Device) {
        ...
        let instances: Vec<BoxInstance> = self
            .highlighted_objects
            .iter()
            .enumerate()
            .map(|(i, obj)| {
                ...
                // Cycle through colors for different objects - bright, semi-transparent colors
                let colors = [
                    Vector4::new(1.0, 0.0, 0.0, 0.6), // Bright Red, semi-transparent
                    Vector4::new(0.0, 1.0, 0.0, 0.6), // Bright Green, semi-transparent
                    Vector4::new(0.0, 0.5, 1.0, 0.6), // Bright Blue, semi-transparent
                    Vector4::new(1.0, 1.0, 0.0, 0.6), // Bright Yellow, semi-transparent
                    Vector4::new(1.0, 0.0, 1.0, 0.6), // Bright Magenta, semi-transparent
                    Vector4::new(0.0, 1.0, 1.0, 0.6), // Bright Cyan, semi-transparent
                ];
